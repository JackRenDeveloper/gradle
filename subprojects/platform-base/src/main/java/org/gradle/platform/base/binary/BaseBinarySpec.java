...
public class BaseBinarySpec extends AbstractBuildableComponentSpec implements BinarySpecInternal {
    ...
    private static class BinaryInfo {
        ...
        BinaryInfo(ComponentSpecIdentifier componentId, Class<? extends BinarySpec> publicType, MutableModelNode modelNode, MutableModelNode componentNode, NamedEntityInstantiator<Task> taskInstantiator, Instantiator instantiator, CollectionCallbackActionDecorator collectionCallbackActionDecorator) {
