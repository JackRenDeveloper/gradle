    ...
    protected void configureBuildScript(InitSettings settings, BuildScriptBuilder buildScriptBuilder) {
        buildScriptBuilder
            ...
            .plugin("Apply the cpp-unit-test plugin to add support for building and running C++ test executables",
                "cpp-unit-test")
            .block("Set the target operating system and architecture for this library", "library", b -> b.methodInvocation(null, "targetMachines.add", buildScriptBuilder.propertyExpression(getHostTargetMachineDefinition())));
    }
}
